...
1. **[WRITING.md](../../../src/agent/mindsets/WRITING.md)** — the voice. Coherent writing: nothing can be removed without loss. Read this first so every sentence you write passes the test.
2. **[skills/skill/SKILL.md](../../../src/agent/skills/skill/SKILL.md)** — the structure. Three-step algorithm: Define (coherence formula), Unfold (sections with high alpha/beta), Rules (imperative + examples).
3. **[skills/README.md](../../../src/agent/skills/README.md)** — the mechanics. Where to put files, what to name them, how to register the skill.
...
4. Write `kata.md` — a minimal exercise that runs the skill end-to-end. See [DOJO.md](./DOJO.md) for kata format.
