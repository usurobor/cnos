...
|----------|--------|--------|-------|
| **ARCHITECTURE.md** | NEW | Created | Top-level entry point. See [../beta/architecture/ARCHITECTURE.md](../beta/architecture/ARCHITECTURE.md) |
...
MANIFESTO, WHITEPAPER (now in identity/), EXECUTABLE-SKILLS
...
|---------|--------|----------------|
| 2026-02-05 incident RCA | ACTOR-MODEL-DESIGN.md s1 | Preserved in archive; consider extracting to docs/beta/evidence/rca/ |
