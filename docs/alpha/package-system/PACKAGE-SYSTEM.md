...
## What packages distribute in cnos

**Version:** 1.0.0
**Status:** Draft
**Addresses:** #119 (template distribution), package-system content model
**Related:**
...
This document defines the canonical set of package content classes in cnos.
It answers:
