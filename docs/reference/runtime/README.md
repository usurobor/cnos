...
| [3.10.0/DESIGN.md](../../alpha/agent-runtime/3.10.0/DESIGN.md) | Feature-scoped design | Wake-up self-model contract: self_model + workspace + capabilities |
| [3.8.0/N-PASS-BIND.md](../../alpha/agent-runtime/3.8.0/N-PASS-BIND.md) | Feature-scoped design | Generalized N-pass bind loop replacing hardcoded two-pass |
| [3.8.0/SYSCALL-SURFACE.md](../../alpha/agent-runtime/3.8.0/SYSCALL-SURFACE.md) | Feature-scoped design | Syscall surface redesign for v3.8.0 |
| [3.7.0/DESIGN.md](../../alpha/agent-runtime/3.7.0/DESIGN.md) | Feature-scoped design | Scheduler design for v3.7.0 |
...
2. **[3.8.0/N-PASS-BIND.md](../../alpha/agent-runtime/3.8.0/N-PASS-BIND.md)** — how the orchestration loop works
3. **[3.10.0/DESIGN.md](../../alpha/agent-runtime/3.10.0/DESIGN.md)** — the wake-up contract design
4. **[3.8.0/SYSCALL-SURFACE.md](../../alpha/agent-runtime/3.8.0/SYSCALL-SURFACE.md)** — the op surface
...
|---------|-----------|-----------|
| v3.14.0 | [3.14.0/](../../alpha/agent-runtime/3.14.0/) | Runtime Contract v2: vertical self-model (4 layers, 5 zone types) |
| v3.10.0 | [3.10.0/](../../alpha/agent-runtime/3.10.0/) | Runtime contract: self_model + workspace + capabilities at wake |
| v3.8.0 | [3.8.0/](../../alpha/agent-runtime/3.8.0/) | N-pass bind loop, processing indicators, syscall surface redesign |
| v3.7.0 | [3.7.0/](../../alpha/agent-runtime/3.7.0/) | Scheduler unification: one loop, two schedulers |
