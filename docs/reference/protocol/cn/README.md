# Protocol — Feature Bundle

The CN protocol: whitepaper, FSM design, and thread API.
...
| Document | Scope |
|----------|-------|
| [GIT-AS-THE-LOWEST-DURABLE-SUBSTRATE.md](./GIT-AS-THE-LOWEST-DURABLE-SUBSTRATE.md) | CN protocol specification (v3.0.1) |
...
1. **[GIT-AS-THE-LOWEST-DURABLE-SUBSTRATE.md](./GIT-AS-THE-LOWEST-DURABLE-SUBSTRATE.md)** — the protocol spec
