...
[1] WHITEPAPER v2.0.3. "Moltbook Failed. Long Live Moltbook. — Git as a Native Communication Surface for AI Agents." docs/architecture/WHITEPAPER.md in cnos. https://github.com/usurobor/cnos
