...
- **`docs/architecture/TRACEABILITY.md`** — Full observability spec (721 lines).
- **`docs/plans/TRACEABILITY-implementation-plan.md`** — 12-step implementation plan.
- **`docs/method/CDD.md`** — Coherence-Driven Development v1.1.0: development method applying CAP to the development process.
...
- **CAA v1.0.0** (`docs/architecture/CAA.md`) — Coherent Agent Architecture spec: structural definition of a coherent agent, 7 invariants, failure mode table, wake-up strata
...
- **`docs/design/CAR-v3.4.md`** — superseded by `docs/architecture/CAR.md` (unified model)
...
- **Implementation plan** (`docs/plans/CAR-implementation-plan.md`) — 8 ordered steps
...
- **Setup installer design doc** — `docs/architecture/SETUP-INSTALLER.md`: guided `cn setup` flow with Telegram auto-detection, persona picker, secrets management
...
- **AGILE-PROCESS** — `docs/method/AGILE-PROCESS.md`: backlog to done workflow
...
- **RCA process** — `docs/evidence/rca/` with template and first incident
