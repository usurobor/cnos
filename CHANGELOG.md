...
|---------|-----|-------------|--------------|------------------|----------------------------------------|
| v3.16.0 | A   | A           | A            | A-               | End-to-end self-update (#37): same-version patch detection, ARM release matrix, target_commitish SHA validation. 3 review rounds (target ≤2), 63% mechanical ratio — no build step before review. |
