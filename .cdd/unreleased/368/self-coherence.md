...
**Known limitation, disclosed:** this is a simulation against historical strings and documented facts, not a re-execution of the actual #367 GitHub merge/close API calls (those cannot be replayed without mutating real repo state). §Debt records this explicitly.
