...
| File | Purpose |
|---|---|
| `cdd-artifact-validate.yml` | Validates the exact `cycle/**` number for merge readiness; main requires a separate exact-cycle nonterminal post-merge closeout invocation, and pre-tag validation uses `--mode release` |
