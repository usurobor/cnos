...
- **`skills/handoff/artifact-channel/SKILL.md`** — α→β→γ channel rules over `.cdd/unreleased/{N}/`; per-role ownership; retention through δ disconnect; post-disconnect archive and terminal seal.
