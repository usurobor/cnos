...
- **[skills/handoff/artifact-channel/SKILL.md](artifact-channel/SKILL.md)** — `.cdd/unreleased/{N}/` α→β→γ channel: ownership + sequential rule + retention through disconnect + post-disconnect archive/terminal seal.
