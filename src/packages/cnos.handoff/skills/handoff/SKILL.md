...
2. Load the sub-skill for the active handoff event:
   ...
   **Subs 2–4 of [cnos#404](https://github.com/usurobor/cnos/issues/404) have landed** (cross-repo via cnos#416; dispatch via cnos#417; mid-flight + artifact-channel via cnos#418). Sub 5 (receipt-stream) is still pending; until it lands, `cnos.cdd/skills/cdd/post-release/SKILL.md §5.6b` and `.cdd/iterations/INDEX.md` carry the post-#411 canonical surface. See [`docs/extraction-map.md`](../../docs/extraction-map.md) for the per-surface source pin.
