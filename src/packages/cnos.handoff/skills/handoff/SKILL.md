...
2. Load the sub-skill for the active handoff event:
   ...
   **Pending Subs 2–5 of [cnos#404](https://github.com/usurobor/cnos/issues/404).** Until each sub lands, the consumer protocol's existing canonical home governs (e.g., `cnos.cdd/skills/cdd/cross-repo/SKILL.md` for the cross-repo case; `cnos.cdd/skills/cdd/gamma/SKILL.md §2.5` + `cnos.cdd/skills/cdd/delta/SKILL.md §2` for dispatch). See [`docs/extraction-map.md`](../../docs/extraction-map.md) for the per-surface source pin.
...
- Dispatch + implementation-contract: [`cnos.cdd/skills/cdd/gamma/SKILL.md §2.5`](../../../cnos.cdd/skills/cdd/gamma/SKILL.md) + [`cnos.cdd/skills/cdd/delta/SKILL.md §2`](../../../cnos.cdd/skills/cdd/delta/SKILL.md)
