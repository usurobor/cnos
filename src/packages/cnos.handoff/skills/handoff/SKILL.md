...
- [`artifact-channel/`](artifact-channel/SKILL.md) — α→β→γ channel rules over `.cdd/unreleased/{N}/`; per-role ownership; retention through disconnect; post-disconnect archive and terminal seal. Per-artifact contents remain canonical at cnos.cds.
