...
| §Lifecycle — lifecycle state machine S0–S12 | `skills/cds/CDS.md §"Development lifecycle" → "State machine"` | Sub 3 | Verbatim move with software-class state names retained (S0 select, S12 close). |
