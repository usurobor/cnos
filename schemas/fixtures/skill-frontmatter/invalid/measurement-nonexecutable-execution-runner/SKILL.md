---
name: measurement-nonexecutable-execution-runner
description: Measurement fixture for State-A execution-mode validation.
...
methodology:
  ...
  execution:
    state: State-A
    runner: "schemas/fixtures/skill-frontmatter/measurement-assets/not-executable.sh"
