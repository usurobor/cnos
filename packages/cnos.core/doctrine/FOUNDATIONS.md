...
- `docs/design/COHERENCE-SYSTEM.md` — Meta-system: how these doctrinal layers compose across agent, runtime, packages, repository, and development (MCP/CMP/CAP/CLP)
